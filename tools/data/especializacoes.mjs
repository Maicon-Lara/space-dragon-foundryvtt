...
// mas passa a usar aquela mesma progressão como multiplicador do ajuste de
// reação da Comunicação. No 10º para de progredir em desarmar e subjugar, e
// ganha uma nave patrocinada. Cada degrau troca uma coisa por outra.
//
// Por isso cada uma vira uma `class_ability` com os três degraus — 5, 10 e 20 —
// e não um item de classe próprio.
//
...
export const especializacoes = [
  {
    ...
    classe: "Cientista",
    afiliacao: "leal",
    n5: "o cientista que almeja tornar-se um pesquisador começa a se dedicar academicamente a partir do 5° nível, parando de progredir em sua habilidade de operar máquinas, mas aumentando seu desconto tecnológico em 1% e mantendo esse progresso a cada novo nível. No entanto, abdica do uso de qualquer arma a não ser seus próprios artefatos. Ao atingir o",
    n10: "10° nível ele pode usar a porcentagem de operar máquinas de seu nível como probabilidade de possuir alguma informação ou artefato relevante a qualquer questão com que se deparar, mas qualquer aparato tecnológico que criar ou feito que realizar é considerado dois níveis tecnológicos acima do listado nas regras, o que permite que pesquisadores construam aparatos ou realizem feitos apenas até o 8° nível tecnológico, que corresponde ao 10° devido a essa penalidade. No",
    n20: "20° nível seu desconto tecnológico é considerado como sendo 100%, mas seu código de ética o proíbe de causar qualquer tipo de dano a seres vivos em combate, e o impele a pregar que ninguém deve fazê-lo.",
  },
  {
    nome: "Inventor",
    classe: "Cientista",
